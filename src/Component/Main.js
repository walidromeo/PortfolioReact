                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-right">
                            ...
                            <div className="desc">Désireux de relever de nouveaux défis, motivée pour apprendre, ponctuelle, autonome et curieux, je souhaite rejoindre votre entreprise afin de participer au développement de vos projet
                            </div>
