            ...
            <section id='contact'>
                ...
                <div className="container">
                    ...
                    <div data-aos="fade-down-left" className="col-lg-12 col-md-12 col-sm-12 col-12 align-self-center text-center p-3">
                     <a href='https://github.com/walidromeo' target="_blank">
                                <i className="fa fa-github f-v fa-1x" id="git" aria-hidden="true"></i>
                            </a>
                            <a href='https://www.linkedin.com/in/walid-bennani-496b72197/' target="_blank">
                                <i className="fa fa-linkedin f-v fa-1x" id="linkedin" aria-hidden="true"></i>
                            </a>
                            <a href='https://www.instagram.com/walid_bennani' target="_blank">
                                <i className="fa fa-instagram f-v fa-1x" id="instagram" aria-hidden="true"></i>
                            </a>
                            <a href='https://drive.google.com/file/d/1fCi42u-ATOjxUB0AU6ECFYSAM7xs6xIq/view?usp=sharing'  target="_blank">
                            <i class="fa fa-file-pdf-o f-v  fa-1x" id="linkedin" aria-hidden="true"></i>
                            </a>
                            <br />
                    </div>
                        <div data-aos="fade-down-left" className="col-lg-6 col-md-6 col-sm-12 col-12 align-self-center p-3">
                        <div className="h1">Contactez-Moi</div>
